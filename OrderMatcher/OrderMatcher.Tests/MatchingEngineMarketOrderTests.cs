...
namespace OrderMatcher.Tests
{
    public class MatchingEngineMarketOrderTests
    {
        ...
        public void CancelOrder_Normal_Market_After_Match_Enters_Pending_With_Limit_Should_Be_Cancel_Price_Sell()
        {
            ...
            Order order2 = new Order { IsBuy = false, OpenQuantity = 1500, Price = 0, OrderId = 2, UserId = 2 };
            ...
            mockTradeListener.Verify(x => x.OnTrade(2, 1, 2, 1, 10, 1000, null, null, 10000, 20));
            mockTradeListener.VerifyNoOtherCalls();
            ...
            mockTradeListener.Verify(x => x.OnCancel(2, 2, 500, 10000, 50, CancelReason.UserRequested));
            mockTradeListener.VerifyNoOtherCalls();
        ...
        public void CancelOrder_Normal_Market_After_Match_Enters_Pending_With_Limit_Should_Be_Cancel_Price_Buy()
        {
            ...
            Order order2 = new Order { IsBuy = true, OpenQuantity = 1500, Price = 0, OrderId = 2, UserId = 2 };
            OrderMatchingResult result2 = matchingEngine.AddOrder(order2, 2);

            mockTradeListener.Verify(x => x.OnAccept(order2.OrderId, order2.UserId));
            mockTradeListener.Verify(x => x.OnTrade(2, 1, 2, 1, 10, 1000, 0, 20, null, null));
            mockTradeListener.VerifyNoOtherCalls();
            Assert.Equal(OrderMatchingResult.OrderAccepted, result2);
            Assert.Contains(order2, matchingEngine.CurrentOrders.Select(x => x.Value));
            Assert.Contains(order2.OrderId, matchingEngine.AcceptedOrders);
        ...
        public void AddOrder_Normal_Market_Matches_Order_With_Open_Orders_For_Sell()
        {
            ...
            Order order2 = new Order { IsBuy = false, OpenQuantity = 500, Price = 0, OrderId = 2, UserId = 2 };
            OrderMatchingResult result2 = matchingEngine.AddOrder(order2, 2);

            mockTradeListener.Verify(x => x.OnAccept(order2.OrderId, order2.UserId));
            mockTradeListener.Verify(x => x.OnTrade(2, 1, 2, 1, 10, 500, 0, 25, null, null));
            mockTradeListener.VerifyNoOtherCalls();
            Assert.Equal(OrderMatchingResult.OrderAccepted, result2);
            Assert.DoesNotContain(order2, matchingEngine.CurrentOrders.Select(x => x.Value));
            Assert.Contains(order2.OrderId, matchingEngine.AcceptedOrders);
        ...
        public void AddOrder_Normal_Market_Matches_Order_With_Open_Orders_For_Buy()
        {
            ...
            Order order2 = new Order { IsBuy = true, OpenQuantity = 500, Price = 0, OrderId = 2, UserId = 2 };
            OrderMatchingResult result2 = matchingEngine.AddOrder(order2, 2);
        ...
        public void AddOrder_Normal_Market_Multiple_Matches_Order_With_Open_Orders_For_Sell()
        {
            ...
            Order order3 = new Order { IsBuy = false, OpenQuantity = 500, Price = 0, OrderId = 3, UserId = 3 };
            ...
            mockTradeListener.Verify(x => x.OnTrade(3, 1, 3, 1, 10, 500, 0, 25, 10000, 20));
            mockTradeListener.VerifyNoOtherCalls();
        ...
        public void AddOrder_Normal_Market_Multiple_Matches_Order_With_Open_Orders_For_Buy()
        {
            ...
            Order order3 = new Order { IsBuy = true, OpenQuantity = 500, Price = 0, OrderId = 3, UserId = 3 };
            OrderMatchingResult result3 = matchingEngine.AddOrder(order3, 3);
        ...
        public void AddOrder_Normal_Market_Matches_Multiple_Order_With_Open_Orders_For_Sell()
        {
            ...
            Order order2 = new Order { IsBuy = true, OpenQuantity = 500, Price = 9, OrderId = 2, UserId = 2 };
            ...
            Order order3 = new Order { IsBuy = false, OpenQuantity = 1000, Price = 0, OrderId = 3, UserId = 3 };
            OrderMatchingResult result3 = matchingEngine.AddOrder(order3, 3);

            mockTradeListener.Verify(x => x.OnAccept(order3.OrderId, order3.UserId));
            mockTradeListener.Verify(x => x.OnTrade(3, 1, 3, 1, 10, 500, null, null, 5000, 10));
            mockTradeListener.Verify(x => x.OnTrade(3, 2, 3, 2, 9, 500, 0, 47.5m, 4500, 9));
            mockTradeListener.VerifyNoOtherCalls();
            Assert.Equal(OrderMatchingResult.OrderAccepted, result3);
            Assert.DoesNotContain(order3, matchingEngine.CurrentOrders.Select(x => x.Value));
            Assert.Contains(order3.OrderId, matchingEngine.AcceptedOrders);
        ...
        public void AddOrder_Normal_Market_Matches_Multiple_Order_With_Open_Orders_For_Buy()
        {
            ...
            Order order3 = new Order { IsBuy = true, OpenQuantity = 1000, Price = 0, OrderId = 3, UserId = 3 };
            OrderMatchingResult result3 = matchingEngine.AddOrder(order3, 3);

            mockTradeListener.Verify(x => x.OnAccept(order3.OrderId, order3.UserId));
            mockTradeListener.Verify(x => x.OnTrade(3, 1, 3, 1, 10, 500, 0, 10, null, null));
            mockTradeListener.Verify(x => x.OnTrade(3, 2, 3, 2, 11, 500, 0, 11, 10500, 52.5m));
            mockTradeListener.VerifyNoOtherCalls();
            Assert.Equal(OrderMatchingResult.OrderAccepted, result3);
            Assert.DoesNotContain(order3, matchingEngine.CurrentOrders.Select(x => x.Value));
            Assert.Contains(order3.OrderId, matchingEngine.AcceptedOrders);
        ...
        {
            Order order1 = new Order { IsBuy = true, OpenQuantity = 500, Price = 0, OrderId = 1, UserId = 1 };
            OrderMatchingResult result1 = matchingEngine.AddOrder(order1, 1);

            mockTradeListener.Verify(x => x.OnAccept(order1.OrderId, order1.UserId));
            mockTradeListener.Verify(x => x.OnCancel(1, 1, 500, 0, 0, CancelReason.MarketOrderNoLiquidity));
            mockTradeListener.VerifyNoOtherCalls();
        ...
        {
            Order order1 = new Order { IsBuy = false, OpenQuantity = 500, Price = 0, OrderId = 1, UserId = 1 };
            OrderMatchingResult result1 = matchingEngine.AddOrder(order1, 1);
        ...
        public void AddOrder_Normal_Market_Complex_Matching_Scenario()
        {
            ...
            Order order7 = new Order { IsBuy = true, OpenQuantity = 2000, Price = 12, OrderId = 7, UserId = 7 };
            ...
            mockTradeListener.Verify(x => x.OnTrade(7, 6, 7, 6, 9, 500, 0, 54, null, null));
            ...
            mockTradeListener.Verify(x => x.OnTrade(10, 7, 10, 7, 12, 500, null, null, 21500, 89.5m));
            ...
            Order order12 = new Order { IsBuy = true, OpenQuantity = 3000, Price = 0, OrderId = 12, UserId = 12 };
            ...
            mockTradeListener.Verify(x => x.OnCancel(12, 12, 3000, 0, 0, CancelReason.MarketOrderNoLiquidity));
            mockTradeListener.VerifyNoOtherCalls();
