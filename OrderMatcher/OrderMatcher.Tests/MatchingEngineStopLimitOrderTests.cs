...
namespace OrderMatcher.Tests
{
    public class MatchingEngineStopLimitOrderTests
    {
        ...
        public void CancelOrder_Cancels_Triggered_Stop_Limit_Order_Buy()
        {
            ...
            Order order4 = new Order { IsBuy = true, OpenQuantity = 500, Price = 10, OrderId = 4, UserId = 4, StopPrice = 11 };
            ...
            Order order5 = new Order { IsBuy = true, OpenQuantity = 500, Price = 10, OrderId = 5, UserId = 5, StopPrice = 13 };
            ...
            Order order6 = new Order { IsBuy = false, OpenQuantity = 500, Price = 12, OrderId = 6, UserId = 6 };
            ...
            mockTradeListener.Verify(x => x.OnTrade(7, 6, 7, 6, 12, 500, 0, 12, 6000, 30));
            ...
            mockTradeListener.Verify(x => x.OnCancel(4, 4, 500, 0, 0, CancelReason.UserRequested));
            mockTradeListener.VerifyNoOtherCalls();
            Assert.Equal(OrderMatchingResult.OrderAccepted, result7);
            Assert.DoesNotContain(order7, matchingEngine.CurrentOrders.Select(x => x.Value));
            Assert.Contains(order7.OrderId, matchingEngine.AcceptedOrders);
        ...
        {
            Order order1 = new Order { IsBuy = true, OpenQuantity = 1000, Price = 10, OrderId = 1, UserId = 1, StopPrice = 9 };
            OrderMatchingResult acceptanceResult = matchingEngine.AddOrder(order1, 1);
        ...
        {
            Order order1 = new Order { IsBuy = false, OpenQuantity = 1000, Price = 10, OrderId = 1, UserId = 1, StopPrice = 9 };
            OrderMatchingResult acceptanceResult = matchingEngine.AddOrder(order1, 1);
        ...
        public void AddOrder_Triggers_Stop_Limit_Order_Ask()
        {
            ...
            Order order4 = new Order { IsBuy = false, OpenQuantity = 500, Price = 10, OrderId = 4, UserId = 4, StopPrice = 9 };
            OrderMatchingResult result4 = matchingEngine.AddOrder(order4, 4);
            ...
            Order order5 = new Order { IsBuy = false, OpenQuantity = 500, Price = 10, OrderId = 5, UserId = 5, StopPrice = 7 };
            OrderMatchingResult result5 = matchingEngine.AddOrder(order5, 5);
            ...
            Order order6 = new Order { IsBuy = false, OpenQuantity = 500, Price = 8, OrderId = 6, UserId = 6 };
            OrderMatchingResult result6 = matchingEngine.AddOrder(order6, 6);
            ...
            Order order7 = new Order { IsBuy = true, OpenQuantity = 500, Price = 8, OrderId = 7, UserId = 7 };
            OrderMatchingResult result7 = matchingEngine.AddOrder(order7, 7);

            mockTradeListener.Verify(x => x.OnAccept(order7.OrderId, order7.UserId));
            mockTradeListener.Verify(x => x.OnTrade(7, 6, 7, 6, 8, 500, 0, 8, 4000, 20));
            mockTradeListener.Verify(x => x.OnOrderTriggered(3, 3));
            mockTradeListener.Verify(x => x.OnOrderTriggered(4, 4));
            mockTradeListener.VerifyNoOtherCalls();
            Assert.Equal(OrderMatchingResult.OrderAccepted, result7);
        ...
        public void AddOrder_Stop_Limit_Order_Added_To_Book_If_Stop_Price_Is_Less_Than_Market_Buy()
        {
            ...
            Order order3 = new Order { IsBuy = true, OpenQuantity = 500, Price = 11, OrderId = 3, UserId = 3, StopPrice = 10 };
            OrderMatchingResult result3 = matchingEngine.AddOrder(order3, 3);
        ...
        public void AddOrder_Stop_Limit_Order_Added_To_Book_If_Stop_Price_Is_More_Than_Market_Sell()
        {
            ...
            Order order3 = new Order { IsBuy = false, OpenQuantity = 500, Price = 10, OrderId = 3, UserId = 3, StopPrice = 10 };
            OrderMatchingResult result3 = matchingEngine.AddOrder(order3, 3);
        ...
        public void AddOrder_Stop_Limit_Trigger_And_Matches_As_Taker_Buy()
        {
            ...
            Order order3 = new Order { IsBuy = true, OpenQuantity = 500, Price = 11, OrderId = 3, UserId = 3, StopPrice = 11 };
            OrderMatchingResult result3 = matchingEngine.AddOrder(order3, 3);
        ...
        public void AddOrder_Stop_Limit_Trigger_And_Matches_As_Taker_Sell()
        {
            ...
            Order order3 = new Order { IsBuy = false, OpenQuantity = 500, Price = 7, OrderId = 3, UserId = 3, StopPrice = 9 };
            OrderMatchingResult result3 = matchingEngine.AddOrder(order3, 3);
        ...
        public void AddOrder_Triggers_Stop_Limit_Order_Buy_Time_Priority()
        {
            ...
            Order order3 = new Order { IsBuy = true, OpenQuantity = 500, Price = 12, OrderId = 3, UserId = 3, StopPrice = 11 };
            OrderMatchingResult result3 = matchingEngine.AddOrder(order3, 3);
            ...
            Order order4 = new Order { IsBuy = true, OpenQuantity = 500, Price = 12, OrderId = 4, UserId = 4, StopPrice = 11 };
            OrderMatchingResult result4 = matchingEngine.AddOrder(order4, 4);
            ...
            Order order5 = new Order { IsBuy = true, OpenQuantity = 500, Price = 13, OrderId = 5, UserId = 5, StopPrice = 12 };
            OrderMatchingResult result5 = matchingEngine.AddOrder(order5, 5);
            ...
            Order order6 = new Order { IsBuy = true, OpenQuantity = 500, Price = 13, OrderId = 6, UserId = 6, StopPrice = 12 };
            OrderMatchingResult result6 = matchingEngine.AddOrder(order6, 6);
            ...
            Assert.Contains(order6, matchingEngine.CurrentOrders.Select(x => x.Value));
            Assert.Contains(order6.OrderId, matchingEngine.AcceptedOrders);
            Assert.Contains(order6, matchingEngine.Book.StopBidSide.SelectMany(x => x.Value));
            Assert.Empty(matchingEngine.Book.BidSide);
            Assert.Empty(matchingEngine.Book.AskSide);
            Assert.Empty(matchingEngine.Book.StopAskSide);
            Assert.Equal(2, matchingEngine.Book.StopBidSide.Count());
            ...
            Order order7 = new Order { IsBuy = true, OpenQuantity = 500, Price = 14, OrderId = 7, UserId = 7, StopPrice = 13 };
            OrderMatchingResult result7 = matchingEngine.AddOrder(order7, 7);
            ...
            Assert.Contains(order7.OrderId, matchingEngine.AcceptedOrders);
            Assert.Contains(order7, matchingEngine.Book.StopBidSide.SelectMany(x => x.Value));
            Assert.Empty(matchingEngine.Book.BidSide);
            Assert.Empty(matchingEngine.Book.AskSide);
            Assert.Empty(matchingEngine.Book.StopAskSide);
            ...
            Order order8 = new Order { IsBuy = true, OpenQuantity = 500, Price = 14, OrderId = 8, UserId = 8, StopPrice = 13 };
            ...
            Assert.Contains(order8, matchingEngine.Book.StopBidSide.SelectMany(x => x.Value));
            Assert.Empty(matchingEngine.Book.BidSide);
            Assert.Empty(matchingEngine.Book.AskSide);
            Assert.Empty(matchingEngine.Book.StopAskSide);
            Assert.Equal(3, matchingEngine.Book.StopBidSide.Count());
            ...
            mockTradeListener.Verify(x => x.OnTrade(13, 12, 13, 12, 11, 500, 0, 27.5m, 5500, 11m));

            mockTradeListener.Verify(x => x.OnOrderTriggered(3, 3));
            mockTradeListener.Verify(x => x.OnTrade(3, 9, 3, 9, 12, 500, null, null, 6000, 30m));
            mockTradeListener.Verify(x => x.OnOrderTriggered(4, 4));
            mockTradeListener.Verify(x => x.OnTrade(4, 9, 4, 9, 12, 500, 0, 24, 6000, 30m));

            mockTradeListener.Verify(x => x.OnOrderTriggered(5, 5));
            mockTradeListener.Verify(x => x.OnTrade(5, 10, 5, 10, 13, 500, null, null, 6500, 32.5m));
            mockTradeListener.Verify(x => x.OnOrderTriggered(6, 6));
            mockTradeListener.Verify(x => x.OnTrade(6, 10, 6, 10, 13, 500, 0, 26, 6500, 32.5m));

            mockTradeListener.Verify(x => x.OnOrderTriggered(7, 7));
            mockTradeListener.Verify(x => x.OnTrade(7, 11, 7, 11, 14, 500, null, null, 7000, 35m));
            mockTradeListener.Verify(x => x.OnOrderTriggered(8, 8));
            mockTradeListener.Verify(x => x.OnTrade(8, 11, 8, 11, 14, 500, 0, 28, 7000, 35m));
